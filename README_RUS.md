...
- Код библиотеки, включая заголовочные файлы, мейкфайлы и саму библиотеку, находиться в папке src;
- Не использованны устаревшие и выведенные из употребления конструкции языка и библиотечные функции. Ориентир на стандарт POSIX.1-2017;
- При написании кода придерживался Google Style;
- Решение оформлено как статическая библиотеку с названием *s21_string.a* (с заголовочным файлом s21_string.h);
- Библиотека разработана в соответствии с принципами структурного программирования, обязательно исключи дублирование в коде;
- Подготовленно полное покрытие unit-тестами функций библиотеки c помощью библиотеки Check;
- Unit-тесты проверяют результаты работы твоей реализации путём сравнения ее с реализацией стандартной библиотеки string.h;
...
- Перед каждой функцией использовал префикс s21_;
...
## Part 3. Реализация некоторых модификаторов формата функции sprintf
...
## Part 4. Реализация функции sscanf
...
## Part 5. Реализация специальных функций обработки строк
